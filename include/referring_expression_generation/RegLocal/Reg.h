#ifndef REG_LOCAL_REGSERVER_H
#define REG_LOCAL_REGSERVER_H
...
{
public:
  Reg(const std::vector<std::string>& onto_files, const std::string& config_path = "");
